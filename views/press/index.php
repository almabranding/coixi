                ...
                <li>
                    <a href="<?php echo $value['link']; ?>">
                        ...
                        <span class="image_media">
                            <span class="google" data-href="https://plus.google.com/share?url=encodeURIComponent(<?php echo IMAGES . $value['page'] . '/' . $value['img']; ?>)" target="_blank" rel="nofollow">
                                <i class="icon-google-plus"></i>
                            </span>
                            <span class="twitter" data-href="http://twitter.com/intent/tweet?text=APRODUCTIONS&url=<?php echo IMAGES . $value['page'] . '/' . $value['img']; ?>" target="_blank" rel="nofollow">
