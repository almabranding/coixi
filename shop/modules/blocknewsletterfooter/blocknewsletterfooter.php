...
class blocknewsletterfooter extends Module
{
 	public function __construct()
 	{
 	 	$this->name = 'blocknewsletterfooter';
		...
		$this->need_instance = 0;
	 	...
	 	parent::__construct();
 	 	...
 	 	$this->displayName = $this->l('Newsletter block footer');
 	...
 	{
 	 	if (parent::install() == false OR $this->registerHook('displayFooter') == false OR $this->registerHook('displayHeader') == false)
 	 		return false;
