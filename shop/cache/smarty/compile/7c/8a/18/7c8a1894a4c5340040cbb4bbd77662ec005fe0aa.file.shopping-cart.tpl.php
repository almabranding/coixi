<?php /* Smarty version Smarty-3.1.13, created on 2013-07-05 14:36:34
         compiled from "/usr/home/borndevelopments.com/web/coixi/shop/themes/biosanyresp/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157351425951d6bdd2e62b12-80439179%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c8a1894a4c5340040cbb4bbd77662ec005fe0aa' => 
    array (
      0 => '/usr/home/borndevelopments.com/web/coixi/shop/themes/biosanyresp/shopping-cart.tpl',
      1 => 1373026804,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157351425951d6bdd2e62b12-80439179',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51d6bdd3dca9c0_36241544',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51d6bdd3dca9c0_36241544')) {function content_51d6bdd3dca9c0_36241544($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/usr/home/borndevelopments.com/web/coixi/shop/tools/smarty/plugins/modifier.escape.php';
?>



<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?>
<?php echo smartyTranslate(array('s'=>'Your shopping cart'),$_smarty_tpl);?>
...
<span class="contains">
<?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
...
"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['lastProductAdded']->value['link_rewrite'],$_smarty_tpl->tpl_vars['lastProductAdded']->value['id_image'],'small');?>
...
<tr class="cart_total_price" style="padding-top:10px">
...
<td colspan="2" class="price" id="total_product" style="padding-right:45px; font-weight:bold"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</td>
...
<td colspan="2" class="price" id="total_product" style="padding-right:45px; font-weight:bold"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products_wt']->value),$_smarty_tpl);?>
</td>
...
<td colspan="2" class="price-discount price" id="total_discount" style="padding-right:45px; font-weight:bold">
...
<td colspan="2" class="price-discount price" id="total_wrapping" style="padding-right:45px; font-weight:bold">
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold"><?php echo smartyTranslate(array('s'=>'Free Shipping!'),$_smarty_tpl);?>
</td>
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</td>
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping']->value),$_smarty_tpl);?>
</td>
...
<td colspan="5" style="text-align:right; font-weight:bold"><?php echo smartyTranslate(array('s'=>'Total (tax excl.):'),$_smarty_tpl);?>
</td>
				
<td colspan="2" class="price" id="total_price_without_tax" style="padding-right:45px; font-weight:bold"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</td>
...
<td colspan="5" style="text-align:right; font-weight:bold"><?php echo smartyTranslate(array('s'=>'Total tax:'),$_smarty_tpl);?>
</td>
				
<td colspan="2" class="price" id="total_tax" style="padding-right:45px; font-weight:bold"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_tax']->value),$_smarty_tpl);?>
</td>
...
<div id="cart_quantity_button" class="cart_quantity_button" style="float:right;">
...
<a href="<?php if ((isset($_SERVER['HTTP_REFERER'])&&strstr($_SERVER['HTTP_REFERER'],'order.php'))||!isset($_SERVER['HTTP_REFERER'])){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('index');?>
