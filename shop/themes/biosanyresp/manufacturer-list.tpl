...
{include file="$tpl_dir./errors.tpl"}{else}	
...
<img src="{$img_manu_dir}{$manufacturer.id_manufacturer|escape:'htmlall':'UTF-8'}-medium.jpg" alt="" />						
...
<a href="{$link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'htmlall':'UTF-8'}"></a>				
{/if}				
</div>			
