...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 8084 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
License (AFL 3.0)*  International Registered Trademark & Property of PrestaShop SA*}

{capture name=path}

<a href="{$link->getPageLink('my-account', true)}">{l s='My account' mod='loyalty'}</a>
...
<td colspan="2" class="history_method bold" style="text-align:center;"><b>{l s='Total points available:' mod='loyalty'}</b></td>				
<td class="history_method" style="text-align:left;"><b>{$totalPoints|intval}</b></td>				
...
<a href="{$link->getModuleLink('loyalty', 'default', ['process' => 'transformpoints'])}" onclick="return confirm('{l s='Are you sure you want to transform your points into vouchers?' mod='loyalty' js=1}');"><img src="{$img_dir}icon/arrow-mini.png" alt="arrow" width="20" height="20" onmouseover="this.src='{$img_dir}icon/arrow-mini-hover.png';" onmouseout="this.src='{$img_dir}icon/arrow-mini.png';" style="vertical-align:-7px" /> <b>{l s='Transform my points into a voucher of' mod='loyalty'} <span class="price">{convertPrice price=$voucher}</span>.</b></a>
</p>
{/if}
...
{if !$smarty.foreach.myLoop.last}|{/if}{/foreach}">{l s='more...' mod='loyalty'}</a>
</td>			
</tr>		
{/foreach}		
</tbody>	
...
{if $minimalLoyalty > 0}
<p>{l s='The minimum order amount in order to use these vouchers is:'} {convertPrice price=$minimalLoyalty}</p>
{/if}
...
<li><a href="{$link->getPageLink('my-account', true)}"><img src="{$img_dir}green_icons/your-account-black-20.png" alt="account" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/your-account-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/your-account-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Back to Your Account' mod='loyalty'}</a></li>	

<li class="f_right"><a href="{$base_dir}"><img src="{$img_dir}green_icons/home-black-20.png" alt="home" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/home-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/home-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Home' mod='loyalty'}</a></li>
