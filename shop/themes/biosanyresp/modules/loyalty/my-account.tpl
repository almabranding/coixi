...
<li class="loyalty">
<a href="{$link->getModuleLink('loyalty', 'default', ['process' => 'summary'])}" title="{l s='My loyalty points' mod='loyalty'}">
<img src="{$img_dir}green_icons/star-black-100.png" class="icon" />
<p>{l s='My loyalty points' mod='loyalty'}</p>
</a>
</li>
