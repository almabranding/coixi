...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 7208 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
...
<img src="{$module_template_dir}images/loyalty.png" alt="{l s='loyalty' mod='loyalty'}" class="icon" style="vertical-align:-5px;padding-right:3px" />	
{if $points > 0}	
	
{l s='By checking out of this shopping cart you can collect up to' mod='loyalty'} 

<span style="color: #EC3E3F">		
...
<span style="color: #EC3E3F">{convertPrice price=$voucher}</span>
...
{if isset($guest_checkout) && $guest_checkout}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>*</sup> <span class="unvalability">{l s='Not available for Instant checkout order' mod='loyalty'}</span>
{/if}	
