...
<a id="send_friend_button" href="#send_friend_form"><img src="{$img_dir}green_icons/mail-black-35.png" alt="send" title="{l s='Send to a friend' mod='sendtoafriend'}" width="35" height="35" onmouseover="this.src='{$img_dir}green_icons/mail-green-35.png';" onmouseout="this.src='{$img_dir}green_icons/mail-black-35.png';" /></a>
</li>
...
<p class="product_name">{$stf_product->name}</p>
