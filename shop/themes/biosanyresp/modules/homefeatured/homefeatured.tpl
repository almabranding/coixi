...
<img src="../img/homeFeaturedHeader.png">
</div>							  
...
<div>
<h5><a href="{$product.link}" title="{$product.name|truncate:50:'...'|escape:'htmlall':'UTF-8'}">{$product.name|truncate:25:'...'|escape:'htmlall':'UTF-8'}</a></h5>					
...
{if $smarty.foreach.homeFeaturedProducts.iteration%$nbItemsPerLine == 0 and !$smarty.foreach.homeFeaturedProducts.last}<div id="featured-products-separator" class="sep" style=""></div>{/if}		
{/foreach}			
