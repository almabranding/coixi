...
<img src="{$img_dir}logo_paiement_visa.png" alt="visa" width="55" height="31" />		
<img src="{$img_dir}logo_paiement_mastercard.png" alt="mastercard" width="55" height="31" />		
<img src="{$img_dir}logo_paiement_paypal.png" alt="paypal" width="55" height="31" />	
