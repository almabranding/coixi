...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 7077 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
License (AFL 3.0)*  International Registered Trademark & Property of PrestaShop SA*}

<div id="mywishlist">	
{capture name=path}

<a href="{$link->getPageLink('my-account', true)}">{l s='My account' mod='blockwishlist'}</a> 
...
<li><a href="{$link->getPageLink('my-account', true)}"><img src="{$img_dir}green_icons/your-account-black-20.png" alt="account" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/your-account-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/your-account-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Back to Your Account' mod='blockwishlist'}</a></li>	

<li class="f_right"><a href="{$base_dir}"><img src="{$img_dir}green_icons/home-black-20.png" alt="home" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/home-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/home-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Home' mod='blockwishlist'}</a></li>
