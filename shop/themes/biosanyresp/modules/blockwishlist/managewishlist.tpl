...
<p class="wishlisturl">Permalink : <input type="text" value="{$base_dir_ssl}modules/blockwishlist/view.php?token={$token_wish|escape:'htmlall':'UTF-8'}" style="width:98%;" readonly="readonly" /></p>		
<p class="submit">			
...
<img src="{$link->getImageLink($product.link_rewrite, $product.cover, 'list')}" alt="{$product.name|escape:'htmlall':'UTF-8'}" />						
</a>					
