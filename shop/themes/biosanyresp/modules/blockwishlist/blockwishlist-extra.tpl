...
<a href="#" id="wishlist_button" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;"><img src="{$img_dir}green_icons/wishlist-black-35.png" alt="Wishlist" title="{l s='Add to my wishlist' mod='blockwishlist'}" width="35" height="35" onmouseover="this.src='{$img_dir}green_icons/wishlist-green-35.png';" onmouseout="this.src='{$img_dir}green_icons/wishlist-black-35.png';" /></a>
</p>