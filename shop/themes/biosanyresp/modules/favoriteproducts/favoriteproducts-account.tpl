...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 16164 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
...
<div class="remove">					
<img rel="ajax_id_favoriteproduct_{$favoriteProduct.id_product}" src="{$img_dir}green_icons/delete-green-20.png" alt="" class="icon" onmouseover="this.src='{$img_dir}green_icons/delete-black-20.png';" onmouseout="this.src='{$img_dir}green_icons/delete-green-20.png';" />				
</div>			
...
<li class="fleft"><a href="{$link->getPageLink('my-account', true)}"><img src="{$img_dir}green_icons/your-account-black-20.png" alt="account" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/your-account-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/your-account-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Back to Your Account' mod='favoriteproducts'}</a></li>	
