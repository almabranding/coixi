...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 15044 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
...
<span>{l s='My account' mod='blockmyaccountfooter'}</span>	
...
<p class="logout"><a href="{$link->getPageLink('index.php')}?mylogout" title="{l s='Sign out' mod='blockmyaccountfooter'}">{l s='Sign out' mod='blockmyaccountfooter'}</a></p>	
