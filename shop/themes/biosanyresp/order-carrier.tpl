...
<h3 class="order_message"><img src="{$img_dir}icon/message_40.png" alt="{l s='Leave a message'}" class="icon" style="vertical-align:-12px" /> {l s='Leave a message'}</h3>

		

<p style="margin-left:7px">{l s='If you would like to add a comment about your order, please write it below.'}</p>
		

<p style="margin-left:7px"><textarea cols="120" rows="3" name="message" id="message">{if isset($oldMessage)}{$oldMessage}{/if}</textarea></p>
