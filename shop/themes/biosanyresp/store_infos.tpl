...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 6752 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free 
...
<table style="font-size: 9px;">	{foreach from=$days_datas  item=one_day}	
<tr>		
