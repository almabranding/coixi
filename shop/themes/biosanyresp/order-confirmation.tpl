...
{else}	
<a href="{$link->getPageLink('history', true)}" title="{l s='Back to orders'}"><img src="{$img_dir}green_icons/cart-green-20.png" alt="{l s='Back to orders'}" class="icon" style="vertical-align:-5px; margin-right:2px" /></a>	
