...
{$path=str_replace('<span class="navigation-pipe">></span>','<span class="navigation-pipe"><div class="arrowBC"></div></span>',$path)}
<div class="breadcrumb">	

<a href="{$base_dir}" title="{l s='return to Home'}">Home</a>

{if isset($path) AND $path}		
<span class="navigation-pipe" {if isset($category) && $category->id_category == 1}style="display:none;"{/if}>{$navigationPipe}</span>
