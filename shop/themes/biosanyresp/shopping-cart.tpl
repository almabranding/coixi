...
* to license@prestashop.com so we can send you a copy 
immediately.
*
* DISCLAIMER
*
...
* versions 
in the future. If you wish to customize PrestaShop for your
* needs please refer to http://www.prestashop.com for 
more information.
*
...
<td colspan="2" class="price" id="total_product" style="padding-right:45px; font-weight:bold">{displayPrice price=$total_products}</td>
...
<td colspan="2" class="price" id="total_product" style="padding-right:45px; font-weight:bold">{displayPrice price=$total_products_wt}</td>
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold">{l s='Free Shipping!'}</td>
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold">{displayPrice price=$total_shipping_tax_exc}</td>
...
<td colspan="2" class="price" id="total_shipping" style="padding-right:45px; font-weight:bold" >{displayPrice price=$total_shipping}</td>
...
<td colspan="5" style="text-align:right; font-weight:bold">{l s='Total (tax excl.):'}</td>
				
<td colspan="2" class="price" id="total_price_without_tax" style="padding-right:45px; font-weight:bold">{displayPrice price=$total_price_without_tax}</td>
			
</tr>
			
<tr class="cart_total_tax">
				
<td colspan="5" style="text-align:right; font-weight:bold">{l s='Total tax:'}</td>
				
<td colspan="2" class="price" id="total_tax" style="padding-right:45px; font-weight:bold">{displayPrice price=$total_tax}</td>
...
<p>{l s='Total :'} <span id="total_price">{displayPrice price=$total_price}</span>
</p>
...
<p>{l s='Total :'} <span id="total_price">{displayPrice price=$total_price_without_tax}</span>
</p>
