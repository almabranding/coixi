...
<p><a href="#" id="openLoginFormBlock"><img src="{$img_dir}green_icons/your-account-black-35.png" alt="login" width="35" height="35" onmouseover="this.src='{$img_dir}green_icons/your-account-green-35.png';" onmouseout="this.src='{$img_dir}green_icons/your-account-black-35.png';" style="vertical-align: -10px;" /> {l s='Click here'}</a></p>
...
<div style="margin-bottom:5px;float:left;width:40%;">					
...
<input type="checkbox" name="invoice_address" id="invoice_address" style="vertical-align:-2px" />					
