...
<p>{l s='Total:'} <span>{displayPrice price=$total_price}</span></p>
...
<p class="submit"><input type="hidden" name="submitDiscount" /><input type="submit" name="submitAddDiscount" value="{l s='ok'}" class="button" />
</p>
