...
{/if}		
{if $start==3}			
<li class="others"><a {$no_follow_text}  href="{$link->goPage($requestPage, 1)}">1</a></li>			
<li class="others"><a {$no_follow_text}  href="{$link->goPage($requestPage, 2)}">2</a></li>		
{/if}		
{if $start==2}			
<li class="others"><a {$no_follow_text}  href="{$link->goPage($requestPage, 1)}">1</a></li>		
{/if}		
...
{else}				
<li class="others"><a {$no_follow_text} href="{$link->goPage($requestPage, $smarty.section.pagination.index)}">{$smarty.section.pagination.index|escape:'htmlall':'UTF-8'}</a></li>			
{/if}		
{/section}		
{if $pages_nb>$stop+2}			
<li class="truncate">...</li>			
<li class="others"><a href="{$link->goPage($requestPage, $pages_nb)}">{$pages_nb|intval}</a></li>		
{/if}		
{if $pages_nb==$stop+1}			
<li><a href="{$link->goPage($requestPage, $pages_nb)}">{$pages_nb|intval}</a></li>		
{/if}		
{if $pages_nb==$stop+2}			
<li class="others"><a href="{$link->goPage($requestPage, $pages_nb-1)}">{$pages_nb-1|intval}</a></li>			
<li class="others"><a href="{$link->goPage($requestPage, $pages_nb)}">{$pages_nb|intval}</a></li>		
{/if}		
