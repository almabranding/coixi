...
* versions in 
the future. If you wish to customize PrestaShop for your
...
addCombination({$idCombination|intval}, new Array({$combination.list}), 
...
'{$combination.available_date}', specific_price_combination);
...
<img id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'small')}" alt="{$image.legend|htmlspecialchars}"" />
...
<p class="resetimg clear"><span id="wrapResetImages" style="display: none;"><img src="{$img_dir}icon/cancel_11x13.gif" alt="{l s='Cancel'}" width="11" height="13"/> 
<a id="resetImages" href="{$link->getProductLink($product)}" onclick="$('span#wrapResetImages').hide('slow');return (false);">{l s='Display all pictures'}</a></span>
</p>
{/if}
...
<label  class="attribute_label" >{l s='Price:'}</label>			
...
<ul id="usefull_link_block" style="width:auto;display:none;">
...
<li class="print"><a href="javascript:print();"><img src="{$img_dir}green_icons/print-black-35.png" alt="Print" title="{l s='Print'}" width="35" height="35" onmouseover="this.src='{$img_dir}green_icons/print-green-35.png';" onmouseout="this.src='{$img_dir}green_icons/print-black-35.png';" /></a></li>
...
{if isset($product) && $product->customizable}<li><a href="#idTab10">{l s='Product customization'}</a></li>
{/if}
...
<li><a href="{$link->getPageLink('attachment', true, NULL, "id_attachment={$attachment.id_attachment}")}">{$attachment.name|escape:'htmlall':'UTF-8'}</a>
<br /><br />
...
<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" title="{$accessory.legend|escape:'htmlall':'UTF-8'}" class="product_image"><img src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'list')}" alt="{$accessory.legend|escape:'htmlall':'UTF-8'}"" /></a>
