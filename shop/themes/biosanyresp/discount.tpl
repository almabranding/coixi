...
SA <contact@prestashop.com>*  @copyright  2007-2012 PrestaShop SA*  @version  Release: $Revision: 6599 $*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free License 
(AFL 3.0)*  International Registered Trademark & Property of PrestaShop SA*}

{capture name=path}

<a href="{$link->getPageLink('my-account.php', true)}">{l s='My account'}</a>
...
<tbody>	{foreach from=$cart_rules item=discountDetail name=myLoop}		
...
<img src="{$img_dir}green_icons/check-green-20.png" alt="{l s='Yes'}" class="icon" style="vertical-align:-3px" /> {l s='Yes'}				
{else}					
<img src="{$img_dir}green_icons/delete-green-20.png" alt="{l s='No'}" class="icon"  style="vertical-align:-3px" /> 
{l s='No'}				
{/if}			
</td>	
...
<li><a href="{$link->getPageLink('my-account', true)}"><img src="{$img_dir}green_icons/your-account-black-20.png" alt="account" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/your-account-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/your-account-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Back to Your Account'}</a></li>	
<li class="f_right"><a href="{$base_dir}"><img src="{$img_dir}green_icons/home-black-20.png" alt="home" width="20" height="20" onmouseover="this.src='{$img_dir}green_icons/home-green-20.png';" onmouseout="this.src='{$img_dir}green_icons/home-black-20.png';" style="vertical-align:-5px; margin-right: 3px" /> {l s='Home'}</a></li>
</ul>